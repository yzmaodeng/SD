...
public class AlipayCore {
	...
	/**
	 * create the order info. 网页支付创建订单信息
	 * 
	 */
	public static String getWebOrderInfo(String subject, String body, String price, String out_trade_no) {
		// 合作者身份ID
		String orderInfo = "app_id=" + "\"" + AlipayConfig.partner + "\"";

		// 卖家支付宝账号
		orderInfo += "&method=" + "\"" + "alipay.trade.wap.pay" + "\"";
		...
		// 服务器异步通知页面路径
		//orderInfo += "&notify_url=" + "\""+ "http://api.bonetoday.com/SD/reward/aliPayCallBack" + "\"";
		orderInfo += "&notify_url=" + "\""+ "http://123.59.57.67/SD/reward/aliPayCallBack" + "\"";
...
//				+ "http://api.bonetoday.com/SD/reward/aliPayCallBack" + "\"";
		orderInfo += "&notify_url=" + "\""
				+ "http://123.59.57.67/SD/reward/aliPayCallBack" + "\"";
